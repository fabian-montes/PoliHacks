    ...
    def iniciar_monitoreo(self):
        with mp.solutions.face_mesh.FaceMesh(
            ...
            while self.cap.isOpened():
                ...
                # ---- CÁLCULO NIVEL DE RENDIMIENTO EN VIVO ----
                porcentaje_actual_enfoque = (sum([r['enfoque_etiqueta'] for r in self.registros_sesion])+int(etiqueta_enfoque)) / (len(self.registros_sesion)+1) * 100
                if porcentaje_actual_enfoque < 40:
                    nivel_rendimiento = "BAJO"
                elif 40 <= porcentaje_actual_enfoque < 70:
                    nivel_rendimiento = "NEUTRO"
                else:
                ...
                cv2.putText(frame,f"RENDIMIENTO:{nivel_rendimiento}",(10,120),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,255),2)
